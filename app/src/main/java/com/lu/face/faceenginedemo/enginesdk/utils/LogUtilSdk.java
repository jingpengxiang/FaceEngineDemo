...
public class LogUtilSdk {
	...
	private static volatile LogUtilSdk mLogUtil;

	public static LogUtilSdk getInstance() {
		if (null == mLogUtil) {
			synchronized (LogUtilSdk.class) {
				if (null == mLogUtil) {
					mLogUtil = new LogUtilSdk();
				}
			}
		}
		return mLogUtil;
