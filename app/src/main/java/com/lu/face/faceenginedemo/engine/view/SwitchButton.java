...
public class SwitchButton extends CompoundButton {
	...
	private void init(AttributeSet attrs) {
		...
		if (attrs != null && getContext() != null) {
			...
			if (typedArray != null) {
				...
				setDrawables(typedArray.getDrawable(R.styleable.SwitchButton_frameDrawable), typedArray.getDrawable(R.styleable.SwitchButton_stateDrawable),
					typedArray.getDrawable(R.styleable.SwitchButton_stateMaskDrawable), typedArray.getDrawable(R.styleable.SwitchButton_sliderDrawable));
				typedArray.recycle();
			}
		}
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		buttonRectF.set(buttonLeft, buttonTop, buttonLeft + (frameDrawable != null ? frameDrawable.getIntrinsicWidth() : 0),
	...
	public int[] onCreateDrawableState(int extraSpace) {
		if (isChecked()) {
			...
			return mergeDrawableStates(super.onCreateDrawableState(extraSpace + 1), CHECK_STATE_SET);
		} else {
			// 如果未选中，直接返回父类的结果
	...
	public void setDrawables(Drawable frameBitmap, Drawable stateDrawable, Drawable stateMaskDrawable, Drawable sliderDrawable) {
		if (frameBitmap == null || stateDrawable == null || stateMaskDrawable == null || sliderDrawable == null) { throw new IllegalArgumentException("ALL NULL"); }
	...
	public void setDrawableResIds(int frameDrawableResId, int stateDrawableResId, int stateMaskDrawableResId, int sliderDrawableResId) {
		if (getResources() != null) {
			setDrawables(getResources().getDrawable(frameDrawableResId), getResources().getDrawable(stateDrawableResId), getResources().getDrawable(stateMaskDrawableResId),
